...
class App < Sinatra::Base
  ...
  post '/' do
    ...
    @signed_request = FBGraph::Canvas.parse_signed_request('SECRET', params[:signed_request])
...
use Rack::Static, :urls => ["/stylesheets", "/images", "/js", "/swfs", "/docs", "/example", "/favicon.ico"], :root => "public"
run App